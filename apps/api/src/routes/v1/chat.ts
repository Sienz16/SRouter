...
import { type ChatCompletionRequest, ChatCompletionRequestSchema } from '@srouter/types';
...
chatRoute.post('/chat/completions', validateJson(ChatCompletionRequestSchema), async (c) => {
